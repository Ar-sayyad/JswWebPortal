                    ...
                    <table class="table form">                                                
                        ...
                        <tr>
                            ...
                            <tr class="sect">
                                ...
                                <th>
                                    <input type="text" id="LEGAL_EXPENSES" name="LEGAL_EXPENSES" value="<?php echo trim($row['LEGAL_EXPENSES']);?>" autocomplete="off" placeholder="Legal Expenses" class="form-control">
                                </th>
                                
                                <th>Cash Purchase :<span class="required"></span></th>
                                <th>
                                      <input type="text" id="CASH_PURCHASE" name="CASH_PURCHASE" value="<?php echo trim($row['CASH_PURCHASE']);?>" autocomplete="off" placeholder="Cash Purchase"  class="form-control">
                                </th>
                            </tr>
                            <tr>
                                <th colspan="4" >
                       ...
                       <tr>
                            <th colspan="4" class="sect2" style="color: #751b85;">
                             ...
                             <tr class="sect2">
                                ...
                                <th>
                                    <input type="text" id="ADMIN_UNIT_CON" name="ADMIN_UNIT_CON" value="<?php echo trim($row['ADMIN_UNIT_CON']);?>" autocomplete="off" placeholder="Admin- Unit Consumption (KWHR)" class="form-control">
                                </th>
                                
                                <th>Admin- Unit Cost :<span class="required"></span></th>
                                <th>
                                    <input type="text" id="ADMIN_UNIT_CON_UINIT_COST" name="ADMIN_UNIT_CON_UINIT_COST" value="<?php echo trim($row['ADMIN_UNIT_CON_UINIT_COST']);?>" autocomplete="off" placeholder="Admin- Unit Cost" class="form-control">
                                </th>
                            </tr>
                            <tr class="sect2">
                                 <th> MHS:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="MHS" name="MHS" value="<?php echo trim($row['MHS']);?>" autocomplete="off" placeholder="MHS" class="form-control">
                                </th>
                                <th> GSU & MHC - 571:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="GSU_MHC" name="GSU_MHC" value="<?php echo trim($row['GSU_MHC']);?>" autocomplete="off" placeholder="GSU & MHC - 571" class="form-control">
                                </th>
                             </tr>
                              ...
                              <tr class="sect2">
                                 <th> Gantry:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="GANTRY" name="GANTRY" value="<?php echo trim($row['GANTRY']);?>" autocomplete="off" placeholder="Gantry" class="form-control">
                                </th>
                                <th> MHS/GANTRY/GSU & MHC - 571 U.COST :<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="MHS_GANTRY_GSU_MHC_COST" name="MHS_GANTRY_GSU_MHC_COST" value="<?php echo trim($row['MHS_GANTRY_GSU_MHC_COST']);?>" autocomplete="off" placeholder="MHS / GANTRY / GSU & MHC - 571 UNIT COST " class="form-control">
                                </th>
                             </tr>
                              <tr class="sect2">
                                 <th>Power Factor Improvement:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="POWER_FACTOR_IMROVEMENT" name="POWER_FACTOR_IMROVEMENT" value="<?php echo trim($row['POWER_FACTOR_IMROVEMENT']);?>" autocomplete="off" placeholder="Saving Power Factor Improvement" class="form-control">
                                </th>
                                <th>Power Factor Month :<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="POWER_FACTOR_MONTH" name="POWER_FACTOR_MONTH" value="<?php echo trim($row['POWER_FACTOR_MONTH']);?>" autocomplete="off" placeholder="Power Factor Month" class="form-control">
                                </th>
                             </tr>
                             <tr>
                                <th colspan="4" >
                        ...
                        <tr class="sect">
                                 <th> DG-1 (1500 KVA) HRS:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="DG1" name="DG1" value="<?php echo trim($row['DG1']);?>" autocomplete="off" placeholder="DG-1 (1500 KVA) HRS" class="form-control">
                                </th>
                                <th> DG-1 (1500 KVA) Unit Generated:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="DG1Unit" name="DG1Unit" value="<?php echo trim($row['DG1Unit']);?>" autocomplete="off" placeholder="DG-1 (1500 KVA) Unit Generated" class="form-control">
                                </th>                                
                             </tr>
                             <tr class="sect">
                                 <th> DG-2 (1500 KVA) HRS:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="DG2" name="DG2" value="<?php echo trim($row['DG2']);?>" autocomplete="off" placeholder="DG-2 (1500 KVA) HRS" class="form-control">
                                </th>
                                <th> DG-2 (1500 KVA) Unit Generated:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="DG2Unit" name="DG2Unit" value="<?php echo trim($row['DG2Unit']);?>" autocomplete="off" placeholder="DG-2 (1500 KVA) Unit Generated" class="form-control">
                                </th>
                             </tr>
                             <tr class="sect">
                                 <th> DG-3 (2000 KVA) HRS:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="DG3" name="DG3" value="<?php echo trim($row['DG3']);?>" autocomplete="off" placeholder="DG-3 (2000 KVA) HRS" class="form-control">
                                </th>
                                <th> DG-3 (2000 KVA) Unit Generated:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="DG3Unit" name="DG3Unit" value="<?php echo trim($row['DG3Unit']);?>" autocomplete="off" placeholder="DG-3 (2000 KVA) Unit Generated" class="form-control">
                                </th>
                             </tr>
                             <tr class="sect">
                                <th> DG sets HRS:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="DG_sets" name="DG_sets" value="<?php echo trim($row['DG_sets']);?>" autocomplete="off" placeholder="DG sets (125+250+100kva) HRS" class="form-control">
                                </th>
                                <th> DG sets Unit Generated:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="DG_setsUnit" name="DG_setsUnit" value="<?php echo trim($row['DG_setsUnit']);?>" autocomplete="off" placeholder="DG sets (125+250+100kva) Unit Generated" class="form-control">
                                </th>
                             </tr>
                             <tr class="sect">
                                 <th> Avg. Diesel Cost:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="AVG_diesel_cost" name="AVG_diesel_cost" value="<?php echo trim($row['AVG_diesel_cost']);?>" autocomplete="off" placeholder="Average diesel cost Rs / Ltr" class="form-control">
                                </th>
<!--                                <th> HEME Diesel Consumption :<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="HEME_DIESEL_CON" name="HEME_DIESEL_CON" value="<?php echo trim($row['HEME_DIESEL_CON']);?>" autocomplete="off" placeholder="HEME Diesel Consumption" class="form-control">
                                </th>
                             </tr>
                             <tr class="sect">
                                 <th> HEME Diesel Unit Cost:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="HEME_DIESEL_CON_UNIT_COST" name="HEME_DIESEL_CON_UNIT_COST" value="<?php echo trim($row['HEME_DIESEL_CON_UNIT_COST']);?>" autocomplete="off" placeholder="HEME Diesel Unit Cost" class="form-control">
                                </th>-->
                                <th colspan="2">&nbsp;</th>
                             </tr>
                             <tr>
                             ...
                             <tr class="sect2">
                                 <th> Total Power Failure:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="TOTAL_POWER_FAILURE" name="TOTAL_POWER_FAILURE" value="<?php echo trim($row['TOTAL_POWER_FAILURE']);?>" autocomplete="off" placeholder="Total Power Failure" class="form-control">
                                </th>
                                <th> Number of Power Trips :<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="Number_of_Power_Trips" name="Number_of_Power_Trips" value="<?php echo trim($row['Number_of_Power_Trips']);?>" autocomplete="off" placeholder="Number of Power Trips" class="form-control">
                                </th>
                             </tr>
                             <tr class="sect2">
                                 <th> FOR VSL OPRNS:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="FOR_VSL_OPRNS" name="FOR_VSL_OPRNS" value="<?php echo trim($row['FOR_VSL_OPRNS']);?>" autocomplete="off" placeholder="FOR VSL OPRNS" class="form-control">
                                </th>
                                <th> FOR RAKE OPRNS :<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="FOR_RAKE_OPRNS" name="FOR_RAKE_OPRNS" value="<?php echo trim($row['FOR_RAKE_OPRNS']);?>" autocomplete="off" placeholder="FOR RAKE OPRNS" class="form-control">
                                </th>
                             </tr>
                            <tr class="sect2">
                                 <th> Saving Rs. Hr of VSL Operation:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="Saving_VSL_Operation" name="Saving_VSL_Operation" value="<?php echo trim($row['Saving_VSL_Operation']);?>" autocomplete="off" placeholder="Saving Rs. Hr of VSL Operation" class="form-control">
                                </th>
                                <th> Budgeted Power failure Hrs. :<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="Budgeted_Power_failure_HRS" name="Budgeted_Power_failure_HRS" value="<?php echo trim($row['Budgeted_Power_failure_HRS']);?>" autocomplete="off" placeholder="Budgeted Power failure Hrs." class="form-control">
                                </th>
                             </tr>
                             <tr class="sect2">
                                 <th> Saving of Power Failure By DG Sets:<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="SAVING_DEMUR_POWER_FAILURE" name="SAVING_DEMUR_POWER_FAILURE" value="<?php echo trim($row['SAVING_DEMUR_POWER_FAILURE']);?>" autocomplete="off" placeholder="Saving of Power Failure By DG Sets" class="form-control">
                                </th>
                                 <th colspan="2">&nbsp;</th>
                             </tr>
                            <tr>
                                <th colspan="4" style="text-align:center">
                                    <button type="button" name="save" data-id="hello" id="editElectrical" class="btn btn-success" value="save"><i class="material-icons">edit</i> Update</button>
...
<script>
   $(document).ready(function(){
    $("#editElectrical").click(function(){
      $("#editElectrical").html('<img src="<?php echo base_url();?>site/content/img/loading.gif" style="width:25px;height:20px;" />');
      $Month= $("#Month").val();
      $year= $("#year").val();
     ...
     $MHS_GANTRY_GSU_MHC_COST= $("#MHS_GANTRY_GSU_MHC_COST").val();       
      ...
      $.post('<?php echo base_url();?>electrical/update/<?php echo $param2;?>', { Month: $Month,year:$year,LEGAL_EXPENSES:$LEGAL_EXPENSES,CASH_PURCHASE:$CASH_PURCHASE,ADMIN_UNIT_CON:$ADMIN_UNIT_CON,
          ...
          //alert(data);
                    if(data==1)
                          {                                  
                                $(".succes_msg").html('<i class="material-icons">check_circle_outline</i> Electrical Details Updated Successfully');
                                $(".succes_msg").show();
