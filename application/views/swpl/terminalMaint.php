                    ...
                    <div class="error_msgg" style="display: none;width: 50%"></div>
                        ...
                        <div class="col-lg-12">
                             ...
                             <div class="card alert">
                                 <div class="col-lg-10">
                                 <form action="<?php echo base_url();?>terminalMaint/searchMaint" method="POST" enctype="multipart/form-data"  class="searchform">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                 ...
                                 <div class="col-lg-2">
                                     <div class="addbtn">
                                      <button data-toggle="modal" onclick="showAjaxModal('<?php echo base_url();?>home/popup/swpl/addTerminal');" class="btn btn-primary" style="float: right" > <i class="material-icons">add_circle_outline</i> Add Terminal Maint</button>
                                    </div>
                                 </div>
                                ...
                                <div class="bootstrap-data-table-panel">
                                    <div class="table-responsive">
                                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">                                         
                                            ...
                                            <tbody>
                                                <?php  if(!empty($mhc_info)){  $sn=1; foreach($mhc_info as $Cranes){?>
                                                <tr>
                                                    <td><?php echo $sn;?></td>
                                                    <td><?php echo $Cranes['Month'];?></td>
                                                    <td><?php echo $Cranes['Year'];?></td>
                                                    <td><?php echo $Cranes['Group_Desc'];?></td>
                                                    <td><?php echo $Cranes['Description'];?></td>
                                                    <td><?php echo $Cranes['Revenue'];?></td>
                                                    <td><?php echo $Cranes['JSWIL_Value'];?></td>
                                                    <td style="text-align: left"> 
                                                        <a style="cursor:pointer" rel="tooltip" title="Edit" class="btn btn-primary btn-link btn-sm" onclick="showAjaxModal('<?php echo base_url();?>home/popup/swpl/editTerminal/<?php echo $Cranes['Sr_No'];?>');">
                                                        <i class="material-icons">edit</i>
                                                        </a>
                                                        
<!--                                                        <a rel="tooltip" title="Remove" class="btn btn-danger btn-link btn-sm" onclick="return checkDelete();" href="<?php echo base_url(); ?>terminalMaint/delete/<?php echo $Cranes['Sr_No'];?>">
