...
<!--                                <th> MHS Unit Cost :<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="MHS_UNIT_COST" name="MHS_UNIT_COST" autocomplete="off" placeholder="MHS Unit Cost" class="form-control">
                                </th>-->
                             </tr>
                             <tr class="sect2">
...
<!--                                <th> GSU & MHS Unit Cost :<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="GSU_MHC_UNIT_COST" value="" name="GSU_MHC_UNIT_COST" autocomplete="off" placeholder="GSU & MHS Unit Cost" class="form-control">
                                </th>-->
                             </tr>
                              <tr class="sect2">
...
<!--                                <th> Gantry Unit Cost :<span class="required"></span></th>
                                  <th>
                                    <input type="text" id="GANTRY_UNIT_COST" name="GANTRY_UNIT_COST" value="" autocomplete="off" placeholder="Gantry Unit Cost" class="form-control">
                                </th>-->
                             </tr>
                              <tr class="sect2">
...
<script>
   $(document).ready(function(){
    $("#saveElectrical").click(function(){
      ...
      //$HEME_DIESEL_CON_UNIT_COST= $("#HEME_DIESEL_CON_UNIT_COST").val(); HEME_DIESEL_CON:$HEME_DIESEL_CON,HEME_DIESEL_CON_UNIT_COST:$HEME_DIESEL_CON_UNIT_COST,     
      ...
      $.post('<?php echo base_url();?>electrical/save', { Month: $Month,year:$year,LEGAL_EXPENSES:$LEGAL_EXPENSES,CASH_PURCHASE:$CASH_PURCHASE,ADMIN_UNIT_CON:$ADMIN_UNIT_CON,
          ...
          AVG_diesel_cost:$AVG_diesel_cost,Saving_VSL_Operation:$Saving_VSL_Operation,
     ...
     $('#LEGAL_EXPENSES').keypress(function (event) {
       ...
       $('#MHS_UNIT_COST').keypress(function (event) {
            return isNumber(event, this);
        });
       $('#GSU_MHC').keypress(function (event) {
            return isNumber(event, this);
        });
       $('#GSU_MHC_UNIT_COST').keypress(function (event) {
            return isNumber(event, this);
        });
       $('#GANTRY').keypress(function (event) {
            return isNumber(event, this);
        });      
       $('#GANTRY_UNIT_COST').keypress(function (event) {
            return isNumber(event, this);
        });
