<ul class="nav Menus" id="dvmsMenu"  style="display:none;">
                            ...
                            <h4 style="">MHS DASHBOARD</h4>
                             <?php if($mydiv3=='New MHS Overview'){?><li class="nav-item mydiv3 active"> <?php }else{?> <li class="nav-item mydiv3"><?php }?>                                       
                               ...
                               <?php if($mydiv3=='Old MHS Overview'){?><li class="nav-item mydiv3 active"> <?php }else{?> <li class="nav-item mydiv3"><?php }?>
                                    ...
                                    <?php if($mydiv3=='Motor Temperature'){?><li class="nav-item mydiv3 activeMenu"> <?php }else{?> <li class="nav-item mydiv3"><?php }?>
                                    ...
                                    <?php if($mydiv3=='Motor Current'){?><li class="nav-item mydiv3 activeMenu"> <?php }else{?> <li class="nav-item mydiv3"><?php }?>
                        ...
                        <ul class="nav Menus" id="manualformsMenu" style="display: none;">
                            ...
                            <?php if($mydiv2=='Jetty'){?><li class="nav-item mydiv4 activeMenu"> <?php }else{?> <li class="nav-item mydiv4"><?php }?>
                                     <a class="nav-link"  href="<?php echo base_url();?>Jetty">
                                        <i class="material-icons">filter_1</i>Jetty Form
                                    </a>
                                </li>
                           <?php if($mydiv2=='MBC'){?><li class="nav-item mydiv4 activeMenu"> <?php }else{?> <li class="nav-item mydiv4"><?php }?>
                                     <a class="nav-link"  href="<?php echo base_url();?>MBC">
                                        <i class="material-icons">filter_2</i> MBC
                                    </a>
                                </li>
                            <?php if($mydiv2=='Cargo Despatch'){?><li class="nav-item mydiv4 activeMenu"> <?php }else{?> <li class="nav-item mydiv4"><?php }?>
                                     <a class="nav-link"  href="<?php echo base_url();?>CargoDespatch">
                                        <i class="material-icons">filter_3</i> Cargo Despatch
                                    </a>
                                </li>
                            <?php if($mydiv2=='Rate Form'){?><li class="nav-item mydiv4 activeMenu"> <?php }else{?> <li class="nav-item mydiv4"><?php }?>
                                     <a class="nav-link"  href="<?php echo base_url();?>RateForm">
                                        <i class="material-icons">filter_4</i> Rate Form
                                    </a>
                                </li>
                            <?php if($mydiv2=='Equipment Delay'){?><li class="nav-item mydiv4 activeMenu"> <?php }else{?> <li class="nav-item mydiv4"><?php }?>
