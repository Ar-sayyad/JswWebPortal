            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-10 col-sm-10" id="MainView">
                          <div class="addbtn" style="margin-top: 0px;">
                                  <form action="<?php echo base_url();?>MBC/searchMBC" method="POST" enctype="multipart/form-data"  class="searchform" style="float:left;width: 70%">
                                ...
                                <button data-toggle="modal" data-target="#modal_ajax" onclick="showAjaxModal('<?php echo base_url();?>Home/popup/jsw/addMBCData');" class="btn btn-primary" style="float:right;width: 18%;margin-top: 20px;" > <i class="material-icons">add_circle_outline</i> Add MBC ETA Data</button>
                           </div> 
